...
then
    ...
    alias irb='/cygdrive/c/Ruby187/bin/irb.bat'
    alias jar='/cygdrive/c/PROGRA~1/Java/jdk1.6.0_24/bin/jar.exe'
    alias java='/cygdrive/c/PROGRA~1/Java/jdk1.6.0_24/bin/java.exe'
    alias javac='/cygdrive/c/PROGRA~1/Java/jdk1.6.0_24/bin/javac.exe'
    alias lettuce='/cygdrive/c/Python27/Scripts/lettuce.exe'
    alias lein='~/professional/software/devtools/leiningen/lein/lein'
