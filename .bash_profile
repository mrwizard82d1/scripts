...
then
    ...
    alias irb='/cygdrive/c/Ruby187/bin/irb.bat'
    alias jar='/cygdrive/c/PROGRA~1/Java/jdk1.6.0_14/bin/jar.exe'
    alias java='/cygdrive/c/PROGRA~1/Java/jdk1.6.0_14/bin/java.exe'
    alias javac='/cygdrive/c/PROGRA~1/Java/jdk1.6.0_14/bin/javac.exe'
