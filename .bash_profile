...
then
    ...
    alias ipy27='/cygdrive/c/Program\ Files/IronPython\ 2.7.1\ Beta\ 1/ipy.exe'
    alias ipycc='ipycc27'
    ...
    alias ipycc27='/cygdrive/c/Program\ Files/IronPython\ 2.7.1\ Beta\ 1/ipy.exe -X:TabCompletion -X:ColorfulConsole'
